...
import { BscComponent } from "./pages/bsc-component/bsc-component.component";
import { BscKpiComponent } from "./pages/bsc-kpi/bsc-kpi.component";
...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        title:
          "Angular BSC Dashboard | TailAdmin - Angular Admin Dashboard Template",
      },
      {
        path: "kpi",
        component: BscKpiComponent,
        title:
          "Angular BSC Dashboard | TailAdmin - Angular Admin Dashboard Template",
      },
      {
